class Player{
    ...
    toggleFullscreen() {
        ...
        fullIcon.classList.toggle('fa-compress-arrows-alt', !full);
    ...
    setVideoTime() {
        ...
        this.player.querySelector('.video-duration').innerHTML = `${Math.floor(duration / 60)} : ${Math.floor(duration % 60)}`;
    }
    timeUpdate() {
        ...
        this.player.querySelector('.video-current').innerHTML = `${Math.floor(current / 60)} : ${seconds}`;
